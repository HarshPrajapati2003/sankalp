  ...
  return (
    <div className="footer-section" id="contact">
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">Sankalp Sahayata</p>
            <p className="ft-description">
              Thank you for visiting Sankalp Sahayata. We deeply appreciate your
              time and interest in our mission. Your support is a crucial step
              toward positive change. Come back soon for more updates on our
              impactful initiatives, and join us in shaping a world where
          ...
          <ul className="ft-list-items" style={{ paddingLeft: "0rem" }}>
            <li>
              <a href="mailto:support@healthplus.com">
                support@sankalpsahayata.com
              </a>
            </li>
            <li>
              <a href="mailto:appointment@healthplus.com">
                info@sankalpsahayata.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        <p>© 2023 Sankalp Sahayata. All rights reserved.</p>
